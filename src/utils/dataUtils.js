...
export const preprocessDataWithDateRange = (rawData, dateRange) => {
  /**
   * Converts raw data from ticks csv and a date range to a TicksCollection object.
